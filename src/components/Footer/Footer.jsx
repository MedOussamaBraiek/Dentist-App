...
const Contact = [
  {
    display: "+216 92 994 247",
    url: "#",
  },
  {
    display: "karimsomai@gmail.com",
    url: "#",
  },
  {
    display: "06, Rue d'Egypte Lafayette - 1002 Tunis",
    url: "#",
  },
];
...
const Footer = () => {
  return (
    <footer className="footer container-fluid mt-5 mb-3">
      <Container className="containerr">
        ...
        <Row>
          <Col lg="6">
            <div className="footer__left">
              <h4 style={{ color: "#1c2498" }} className="mb-5">
          ...
          <Col lg="6">
            <div className="d-flex justify-content-around flex-wrap">
              ...
              <Col lg="4" md="3" sm="6">
                <h5 className="list__title">Contact</h5>
                <ListGroup className="list__group">
        ...
        <Row className="mt-5">
          <Col lg="6" className="links d-flex justify-content-start gap-5">
            <div className="d-flex gap-4">
              <a href="https://www.facebook.com/profile.php?id=100076367562761">
                <svg
          ...
          <Col lg="6" className=" links d-flex gap-5 list__item">
